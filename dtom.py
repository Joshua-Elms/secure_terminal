...
warning_msg_1 = (
    "Hey whoaaaaaa you can't be on this computer! Don't you have a lab meeting to run?"
)
warning_msg_2 = ""
voice = (
    "Bad News"  # voice for macOS 'say' command, find more with "say -v ? | grep en_US"
)
lock_computer = True  # set to False to skip locking the computer
shutdown_after_rounds = 3
volume_level = 5  # macOS volume level (0-10)
